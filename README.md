...
4. Scrape the HTML files:
  ...
  For data cleaning, `scrape.py` runs a bunch of scrips and exports to a seperate file. We are not especially proud of the Releasedate, and we are aware that the we need to change our data formats. 
